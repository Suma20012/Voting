...
if (mysqli_num_rows($sql) >0 ) {
	...
	$error = "<center><h3><font color='#FF0000'>Incorrect Username or Password</h3></center></font>";
	include "login.php";
}
}
else {
	$error = "<center><h3><font color='#FF0000'>Invalid Username or Password</h3></center></font>";
	include "login.php";
}
?>