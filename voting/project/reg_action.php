...
echo "<h2>Successfully Registered! <a href= 'login.php'>Clich here to Login </a></h2>";
}
}
else {
	 $error="<center><h4><bgcolor:'#fe036a'>Registration Failed Due To Error !</h4></center></font>";
     include"register.php";
}
?>
